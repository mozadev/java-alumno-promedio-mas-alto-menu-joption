        ...
        do {// creando el menu
            ...
            switch (opc) {
                ...
                case 2: // calculo del mayor promedio
                    double mayor = 0;
                    String alumnoMayorPromedio = " ";
                    String mensaje;
                    for (int i = 0; i < num; i++) {
                        if (mayor < promedio[i]) {
                            mayor = promedio[i];
                            alumnoMayorPromedio = nombres[i];

                        }
                    }
                    String mayorCadena = String.valueOf(mayor);

                    LE.mostrarInformacion(alumnoMayorPromedio + " nota :  " + mayorCadena);
